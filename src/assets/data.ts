...
const _images: Image[] = [
  {
    id: 1,
    path: 'https://r2.chrismeyers.net/builds/mattBuild.jpg',
    thumbnail: null,
  ...
  {
    id: 2,
    path: 'https://r2.chrismeyers.net/builds/myBuild2013.jpg',
    thumbnail: null,
  ...
  {
    id: 3,
    path: 'https://r2.chrismeyers.net/builds/markBuild.jpg',
    thumbnail: null,
  ...
  {
    id: 4,
    path: 'https://r2.chrismeyers.net/builds/myBuild2016_liquid.jpg',
    thumbnail: null,
  ...
  {
    id: 5,
    path: 'https://r2.chrismeyers.net/builds/jamesBuild.jpg',
    thumbnail: null,
  ...
  {
    id: 6,
    path: 'https://r2.chrismeyers.net/projects/genomic/genomic.png',
    thumbnail: null,
  ...
  {
    id: 7,
    path: 'https://r2.chrismeyers.net/projects/pinelands/pinelands_landing.jpg',
    thumbnail: null,
  ...
  {
    id: 8,
    path: 'https://r2.chrismeyers.net/projects/pinelands/pinelands_tour.jpg',
    thumbnail: null,
  ...
  {
    id: 9,
    path: 'https://r2.chrismeyers.net/projects/pinelands/pinelands_contact.jpg',
    thumbnail: null,
  ...
  {
    id: 10,
    path: 'https://r2.chrismeyers.net/projects/ttt/ttt_land.png',
    thumbnail: null,
  ...
  {
    id: 11,
    path: 'https://r2.chrismeyers.net/projects/ttt/ttt_port.png',
    thumbnail: null,
  ...
  {
    id: 12,
    path: 'https://r2.chrismeyers.net/projects/lol_playerdata/loldata_landing.png',
    thumbnail: null,
  ...
  {
    id: 13,
    path: 'https://r2.chrismeyers.net/projects/lol_playerdata/loldata.png',
    thumbnail: null,
  ...
  {
    id: 14,
    path: 'https://r2.chrismeyers.net/projects/lol_playerdata/loldata_small.png',
    thumbnail: null,
  ...
  {
    id: 15,
    path: 'https://r2.chrismeyers.net/projects/pca/scoresPlot.png',
    thumbnail: null,
  ...
  {
    id: 16,
    path: 'https://r2.chrismeyers.net/projects/pca/scoresData.png',
    thumbnail: null,
  ...
  {
    id: 17,
    path: 'https://r2.chrismeyers.net/projects/pca/addinBar.PNG',
    thumbnail: null,
  ...
  {
    id: 18,
    path: 'https://r2.chrismeyers.net/projects/pca/scoresInput-full.png',
    thumbnail: null,
    title:
  ...
  {
    id: 19,
    path: 'https://r2.chrismeyers.net/projects/bms/bms_rawData.png',
    thumbnail: null,
  ...
  {
    id: 20,
    path: 'https://r2.chrismeyers.net/projects/bms/bms_formatForm.png',
    thumbnail: null,
  ...
  {
    id: 21,
    path: 'https://r2.chrismeyers.net/projects/bms/bms_formattedData.png',
    thumbnail: null,
  ...
  {
    id: 22,
    path: 'https://r2.chrismeyers.net/projects/bms/bms_finalData.png',
    thumbnail: null,
  ...
  {
    id: 23,
    path: 'https://r2.chrismeyers.net/projects/bms/bms_graphForm.png',
    thumbnail: null,
  ...
  {
    id: 24,
    path: 'https://r2.chrismeyers.net/projects/bms/bms_plot.png',
    thumbnail: null,
  ...
  {
    id: 25,
    path: 'https://r2.chrismeyers.net/projects/lol_status/gui.png',
    thumbnail: null,
    title:
  ...
  {
    id: 26,
    path: 'https://r2.chrismeyers.net/projects/lol_status/polling.png',
    thumbnail: null,
  ...
  {
    id: 27,
    path: 'https://r2.chrismeyers.net/projects/lol_status/tray.png',
    thumbnail: null,
  ...
  {
    id: 29,
    path: 'https://r2.chrismeyers.net/builds/myBuild2021.jpg',
    thumbnail: null,
...
const _projects: Project[] = [
  {
    ...
    summary:
      'Personal portfolio site rebuilt over the years from plain HTML through Vue, React, and now Astro.',
    role: 'Solo project',
  ...
  },
  {
    ...
    summary:
      'Java app for Genomic Solutions Now that parses lab patient reports and exports simplified results to Excel.',
  ...
  },
  {
    ...
    summary:
      'PHP and JavaScript web app that builds custom tours from user-selected points of interest.',
    role: 'Solo project',
    status: 'Complete',
  ...
  },
  {
    ...
    languages: ['Java'],
    info: 'Classic Tic-Tac-Toe implemented as an Android app in Java.',
    summary: 'An Android version of Tic-Tac-Toe.',
    role: 'Solo Project',
    status: 'Complete',
  ...
  },
  {
    ...
    summary:
      'PHP app using the Riot Games API to look up and parse League of Legends player stats (legacy API; no longer live).',
    role: 'Solo Project',
    status: 'Complete',
  ...
  },
  {
    ...
    summary:
      'C# Excel add-in extending a Bristol-Myers Squibb PCA tool with principal component visualization.',
  ...
  },
  {
    ...
    summary:
      'C# Excel add-in that formats IonOptix cardiomyocyte data, runs statistics, and plots results for Bristol-Myers Squibb.',
    role: 'Solo Project',
    status: 'Complete',
    images: [
      images.get(19),
  ...
  },
  {
    ...
    summary:
      'Java desktop app that polls the Riot API and shows League of Legends regional service status in the system tray.',
    role: 'Solo Project',
    status: 'Complete',
  ...
  },
  {
    ...
    summary:
      'Python CLI that reads a CSV of addresses and writes a Garmin-compatible file for bulk GPS import.',
    role: 'Solo Project',
    status: 'Complete',
    images: [],
  },
  {
    ...
    summary:
      'Python package that prints multi-part status messages with an animated loading bar between updates.',
    role: 'Solo Project',
  ...
  },
  {
    ...
    summary:
      'JavaScript library for composable data validation and transformation pipelines with custom validators and shifters.',
    role: 'Solo Project',
    status: 'In Development',
    images: [],
  },
  {
    ...
    `,
    summary:
      'Go command-line tool for searching Spotify and browsing results in a Bubble Tea terminal UI.',
    role: 'Solo Project',
    status: 'In Development',
  ...
  },
  {
    ...
    summary:
      'Small Go hex dump utility with output behavior similar to the standard <code>hexdump(1)</code> command.',
    role: 'Solo Project',
    status: 'In Development',
