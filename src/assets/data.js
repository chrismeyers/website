...
export const image = (id) => {
  ...
  console.assert(img?.id === id, 'incorrect image', { id, img });
  return img;
};
...
export const projects = [
  ...
  },
  {
    ...
    role: 'Solo Project',
    status: 'Complete',
    images: [image(12), image(13), image(14)],
  },
  {
    id: 6,
    active: true,
    ...
    status: 'Complete',
    images: [image(15), image(16), image(17), image(18)],
  },
  {
    id: 7,
    active: true,
    ...
    role: 'Solo Project',
    status: 'Complete',
    images: [image(19), image(20), image(21), image(22), image(23), image(24)],
  },
  {
    id: 8,
    active: true,
    ...
    role: 'Solo Project',
    status: 'Complete',
    images: [image(25), image(26), image(27)],
  },
  {
    id: 9,
    active: true,
