...
const AboutContent = () => (
  <>
    ...
    <ul>
      ...
      <li>
        ...
        <ul>
          ...
          <li>Photography</li>
          <li>
            <a className="fancytxt" href="/builds">
    ...
    {summary.languages.all.length > 0 && (
      <>
        <p>
          ...
          ranging from desktop and CLI applications to web applications and REST
          APIs using:
        </p>
    ...
    <p>
      ...
      and maintainable code. My primary goal is to create innovative and usable
      applications that solve real problems. If you have any questions,
