...
export const MAILTO_HREF = 'mailto:chris@chrismeyers.net';
export const MAILTO_HREF_MESSAGE = `${MAILTO_HREF}?subject=Message%20from%20chrismeyers.net`;
export const MAILTO_HREF_RESUME = `${MAILTO_HREF}?subject=Request%20for%20resume%20PDF`;
