...
const imageSchema = S.object()
  .prop('id', S.number())
  .prop('path', S.string())
  .prop('thumbnail', S.string().raw({ nullable: true }))
  .prop('title', S.string())
  .prop('pos', S.number())
...
const buildSchema = S.object()
  ...
  .prop('cpu', S.string())
  .prop('cool', S.string().raw({ nullable: true }))
  .prop('mobo', S.string())
  .prop('ram', S.string())
  .prop('hdd', S.string())
  .prop('ssd', S.string().raw({ nullable: true }))
  .prop('gpu', S.string())
  .prop('case', S.string())
  .prop('psu', S.string())
...
const projectSchema = S.object()
  ...
  .prop('active', S.boolean())
  .prop('title', S.string())
  .prop('webUrl', S.string().format(S.FORMATS.URL).raw({ nullable: true }))
  .prop('codeUrl', S.string().format(S.FORMATS.URL))
  .prop('displayDate', S.string())
  .prop('startedDate', S.string().format(S.FORMATS.DATE_TIME))
  .prop('lang', S.string())
  .prop('info', S.string())
...
const resumeSchema = S.object()
  ...
  .definition(
    ...
    S.array()
      ...
      .items(
        S.object()
          .prop('url', S.string().format(S.FORMATS.URL))
